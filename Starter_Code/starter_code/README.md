...
2 python files VacationPy-Jeremy & WeatherPy-Jeremy
...
Note I did receive some minor help from TL Ramida on WeatherPy Only
installing citipy using pip and fixing error in code due to a few incorrect dictionary names for parsing out max temp and wind speed
